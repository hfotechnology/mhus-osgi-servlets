...
public class WebServiceInfoImpl extends WebServiceInfo {
    ...
    public WebServiceInfoImpl(
            JavaWebServiceAdminImpl admin, ServiceReference<JavaWebService> reference) {
        this.admin = admin;
    ...
    public void connect() {
        if (isConnected() || getName() == null || getName().length() == 0 || service == null)
            return;
        error = null;
        endpoint = null;
        ...
        if (endpoint != null) service.published(this);
    }
